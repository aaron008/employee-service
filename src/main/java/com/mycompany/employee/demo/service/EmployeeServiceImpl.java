...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public Employee updateEmployee(SaveEmployeeRequest request) throws NoEmployeeFoundException{
		...
		if(optionalEmployeeDTO.isPresent()) {
			...
			employeeDTO = mapUpdateEmployeeDTO(employeeDTO, request);
			EmployeeDTO savedEmployeeDTO = employeeRepository.save(employeeDTO);
	...
	private EmployeeDTO mapUpdateEmployeeDTO(EmployeeDTO employeeDTO, SaveEmployeeRequest request) {
	...
	private EmployeeDTO mapSaveEmployeeDTO(SaveEmployeeRequest employee) {
	...
	private Employee mapEmployee(EmployeeDTO employeeDTO) {
		return Employee.builder()
									.address1(employeeDTO.getAddress1())
									.address2(employeeDTO.getAddress2())
